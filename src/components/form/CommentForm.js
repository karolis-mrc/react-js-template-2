...
class CommentForm extends Component {
  ...
  render() {
    return (
      <form onSubmit={this.submitForm} method="post" id="commentform" className="comment-form">
        <div className="form-group form-group-lg no-lg-space">
          <p className="comment-notes">
            Your email address will not be published. Required fields are marked <span className="required">*</span>
          </p>
        </div>

        <div className="form-group form-group-xs no-xs-space">
          <textarea
            id="comment"
            name="comment"
        ...
        <div className="form-group form-group-xs">
          <p className="comment-form-cookies-consent custom-control custom-checkbox">
            ...
            <label className="custom-control-label" htmlFor="wp-comment-cookies-consent">
