  ...
  return (
    <div id="menu-alignment">
      ...
      <p>
        ...
        <code>.dropdown-menu-right</code> to a <code>.dropdown-menu</code> to right align the dropdown menu.
      </p>

      <div className="bd-example">
        <DropdownButton alignRight as={ButtonGroup} title="Right-aligned menu" id="dropdown-menu-align-right" variant="secondary">
          <Dropdown.Item href="#menu-alignment/action" eventKey="1">
            Action
          </Dropdown.Item>
          <Dropdown.Item href="#menu-alignment/action" eventKey="2">
            Another action
          </Dropdown.Item>
          <Dropdown.Item href="#menu-alignment/action" eventKey="3">
            Something else here
          </Dropdown.Item>
        </DropdownButton>
      </div>
      ...
      <div id="responsive-alignment">
        ...
        <p>
          If you want to use responsive alignment, disable dynamic positioning by adding the <code>data-display="static"</code> attribute
          and use the responsive variation classes.
        </p>
        <p>
          To align <strong>right</strong> the dropdown menu with the given breakpoint or larger, add{' '}
        ...
        <p>
          To align <strong>left</strong> the dropdown menu with the given breakpoint or larger, add <code>.dropdown-menu-right</code> and{' '}
        ...
        <p>
          Note that you don’t need to add a <code>data-display="static"</code> attribute to dropdown buttons in navbars, since Popper.js
