      ...
      <div className="card-post-example">
        ...
        <div className="bd-example">
          <div className="row">
                  ...
                  <div className="card-meta">
                    <p>
                      <span>
                        <a
                          title="Category"
                          className="btn btn-before-dot btn-link border-0 p-0 min-w-auto link-no-space"
                          href="#card-post/action"
                        >
                          Category
                        </a>
                      </span>
            ...
            <div className="col-6">
              <div className="card card-post">
                <div className="card-top position-relative">
                  <a title="Post name" href="#card-post">
                    <div className="img object-fit overflow-hidden">
                      <div className="object-fit-cover transform-scale-h">
                        <svg
                          className="bd-placeholder-img card-img-top"
        ...
        <PrismCode
          code={
            ...
            '          <p>\n' +
            '            <span>\n' +
            '              <a title="Category" className="btn btn-before-dot btn-link border-0 p-0 min-w-auto link-no-space" href="#">Category</a>\n' +
            '            </span>\n' +
            '          </p>\n' +
            '        </div>\n' +
            '        <h5 className="card-title">\n' +
          ...
          <div className="row">
            <div className="col-6">
              <div className="card card-post sticky">
                <div className="card-top position-relative">
                  <a title="Post name" href="#card-post-sticky/action">
                    <div className="img object-fit overflow-hidden">
                      <div className="object-fit-cover transform-scale-h">
                        <svg
                          className="bd-placeholder-img card-img-top"
                ...
                <div className="card-body">
                  ...
                  <h5 className="card-title">
                    <a title="Neque porro quisquam est qui" href="#card-post-sticky/action">
                      Neque porro quisquam est qui
                    </a>
                  </h5>
              ...
              <div className="card card-post no-thumbnail">
                <div className="card-body">
                  <div className="card-meta">
                    <p>
                      <span>
                        <a className="a-small" href="news-single-post.html">
                          By admin
                        </a>
                      </span>
                      <span className="s-small">-</span>
                      <span className="s-small">Comments (1)</span>
                      <span className="s-small">-</span>
                      <span className="category">
                        <a title="Category" className="a-small" href="news.html">
                          Category
                        </a>
                      </span>
                    </p>
                  ...
                  <h4 className="card-title">
                    <a title="Neque porro quisquam est qui dolorem ipsum quia" href="#card-post-no-thumbnail/action">
