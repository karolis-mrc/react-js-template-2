...
const UserInterface = () => {
  ...
  return (
    <Fragment>
      <MetaTags>
        <meta charSet="UTF-8" />
        <title>UI | Olum - Business & Events Management Agency HTML Template</title>
            ...
            <div className="content">
              <div className="row gutter-width-sm">
                ...
                <div className="col-md-12 col-lg-8 col-xl-8">
                  <p>
                    Olum project is created using Bootstrap 4 Framework and all of the examples below are based on it. Also, Ency includes
                    custom classes, plugins and scripts which are also based on our experience of Bootstrap 4 Framework.
                  </p>
